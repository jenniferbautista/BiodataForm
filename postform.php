...
Date of Birth: <input class="spc1" type="text" name="DB"> 
...
Place of Birth: <input class="spc1" type="text" name="PB">
...
Languages or Dialects Spoken :<input class="spc" type="text" name="LDS"><br> <br>
